...
class CreateUserTest extends BaseTest {
  ...
  "Try to create user with missing password parameter" should "fail with bad request 400" in {
    ...
    val expectedError = "The request content was malformed: Cannot construct instance of `model.command.CreateUserCommand`, problem: requirement failed: Password cannot be null"
  ...
  "Try to create user with empty email" should "fail with bad request 400" in {
    ...
    val expectedError = "The request content was malformed: Cannot construct instance of `model.command.CreateUserCommand`, problem: requirement failed: Email cannot be empty"
  ...
  "Try to create user with missing email parameter" should "fail with bad request 400" in {
    ...
    val expectedError = "The request content was malformed: Cannot construct instance of `model.command.CreateUserCommand`, problem: requirement failed: Email cannot be null"
