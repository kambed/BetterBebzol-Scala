...
import rest.api.controller.product.{CreateProductController, EditProductController, GetProductByIdController}
...
object SwaggerDocService extends SwaggerHttpService {
  ...
  private val productControllers = Set(classOf[CreateProductController], classOf[EditProductController], classOf[GetProductByIdController])
